# CallbackManager
The CallbackManager resource allows you to easily setup server and client callbacks to quickly and efficiently communicate between server and client sides of a script.

### Dependencies
- [DevJacob_CommonLib](https://github.com/DevJacob-Studios/DevJacob_CommonLib)

### Installation
Installing the resource is simple, just download the latest version from the [releases](https://github.com/DevJacob-Studios/DevJacob_CallbackManager/releases/latest) tab, place the folder into your FiveM resources folder and then add `ensure DevJacob_CallbackManager` to your server.cfg file.
